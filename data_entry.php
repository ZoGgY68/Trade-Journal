    ...
    <div class="container">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($trade['price']); ?></td> <!-- Renamed header -->
                <td><?php echo htmlspecialchars($trade['exit_date']); ?></td>
                <td><?php echo htmlspecialchars($trade['exit_price']); ?></td>
                <td><?php echo htmlspecialchars($trade['stop_loss']); ?></td>
                <td><?php echo htmlspecialchars($trade['take_profit']); ?></td>
                <td><?php echo htmlspecialchars($trade['profit_loss']); ?></td>
